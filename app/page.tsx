...
export default async function HomePage({
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-[#0F665C] rounded-full flex items-center justify-center">
                <Sparkles className="w-4 h-4 text-white" />
              </div>
              <span className="text-xl font-bold">
                <span className="text-[#0F665C]">KSAA</span>
                <span className="text-[#F37321] text-sm ml-1">STEMCARE</span>
              </span>
            </div>
            <div className="flex items-center gap-4">
              <Link href={loginUrl} className="text-gray-600 hover:text-[#0F665C] transition-colors">
                Login
              </Link>
              <Button asChild className="bg-[#0F665C] hover:bg-[#0a4f47] text-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#0F665C] via-[#0a4f47] to-[#083d38] text-white py-20 lg:py-32 overflow-hidden">
        {/* Decorative elements */}
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <Badge className="bg-[#0F665C]/10 text-[#0F665C] border-[#0F665C]/20 mb-4">
              Our Services
            </Badge>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.length > 0 ? (
              services.map((service: any) => (
                <Card key={service.id} className="border border-[#0F665C]/20 hover:border-[#0F665C]/50 hover:shadow-lg transition-all duration-300 group">
                  <CardHeader>
                    <div className="w-12 h-12 bg-[#0F665C]/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-[#0F665C] transition-colors">
                      <Stethoscope className="w-6 h-6 text-[#0F665C] group-hover:text-white transition-colors" />
                    </div>
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between">
                      {service.priceMYR > 0 ? (
                        <span className="text-[#0F665C] font-bold text-lg">
                          RM {service.priceMYR.toFixed(2)}
                        </span>
                      ) : (
                        <Badge className="bg-green-100 text-green-700 border-none">FREE</Badge>
                      )}
                      <Button asChild variant="ghost" size="sm" className="text-[#0F665C] hover:text-[#0F665C] hover:bg-[#0F665C]/10">
                        <Link href={signupUrl}>
              ...
              <>
                {[
                  ...
                  <Card key={idx} className="border border-[#0F665C]/20 hover:border-[#0F665C]/50 hover:shadow-lg transition-all duration-300 group">
                    <CardHeader>
                      <div className="w-12 h-12 bg-[#0F665C]/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-[#0F665C] transition-colors">
                        <Stethoscope className="w-6 h-6 text-[#0F665C] group-hover:text-white transition-colors" />
                      </div>
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between">
                        {service.price === 'FREE' ? (
                          ...
                          <span className="text-[#0F665C] font-bold text-lg">{service.price}</span>
                        )}
                        <Button asChild variant="ghost" size="sm" className="text-[#0F665C] hover:text-[#0F665C] hover:bg-[#0F665C]/10">
                          <Link href={signupUrl}>
                            Book Now <ChevronRight className="ml-1 w-4 h-4" />
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose <span className="text-[#0F665C]">KSAA Stemcare</span>?
            </h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#0F665C] rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      {/* CTA Section */}
      <section className="py-16 lg:py-20 bg-[#0F665C]">
